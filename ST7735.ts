...
const Font12_Table = hex``
...
namespace LCD1IN8 {
    ...
    export function DisplayString(Xchar: number, Ychar: number, ch: string, Color: number): void {
        ...
        for (i = 0; i < ch_len; i++) {
            ...
            if (ch_asicc >= 97 && ch_asicc <= 122)
            {
                ch_asicc -= 32;
            }
            ch_asicc -= 32;
            let Char_Offset = ch_asicc * 9;
